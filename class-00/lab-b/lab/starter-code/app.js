...
// in this instance it would be an undefined object, it is undefined because "this" has nothing to reference.
// 2. What is "this" when joe.scopeArrow() is invoked?
// It is nothing. Since arrow functions don't bind "this", it is looking for the next enclosing scope which would make it undefined.
// 3. Explain why "this" is different when an arrow function is used.
// "this" is idifferent because in an arrow function it is trying to bind something that doesn't exist.
